<template>
  <div class="p-4 text-justify">
    ...
    <h2 class="mt-8 mb-4 text-3xl">I. Verantwortlicher Anbieter der Website</h2>
    ...
    <h3 class="mt-8 mb-4 text-xl">a) Session cookies</h3>
    ...
    <h3 class="mt-8 mb-4 text-xl">b) Third party cookies</h3>
    ...
    <h3 class="mt-8 mb-4 text-xl">c) Deaktivieren von Cookies</h3>
    ...
    <h2 class="mt-8 mb-4 text-3xl">2. Verarbeitung von personenbezogenen Daten durch Dritte</h2>
    <h2 class="mt-8 mb-4 text-xl font-bold">Cloudflare</h2>
